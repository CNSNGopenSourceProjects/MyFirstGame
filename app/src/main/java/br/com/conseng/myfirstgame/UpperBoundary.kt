 ...
 * 20180119     F.Camargo       Cria a borda superior com altura variável.
 **************************************************************************************************/

import android.graphics.Canvas

/**
 * Container for one segment of the upper boundary logic.
 * This segment speed is the same speed of the background.
 * @constructor Creates the single frame image of the upper boundary.
...
class UpperBoundary(private val ac: AnimationClass, private val x: Int,
    ...
    /**
     * Move the upper boundary with the background scenarios.
     */
    fun update() {
        this.xc += this.dxc
    }
